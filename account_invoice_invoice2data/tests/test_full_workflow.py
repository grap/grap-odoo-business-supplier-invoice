...
class TestFullWorkflow(TestModule):
    def setUp(self):
        ...
        self.invoice_line_1_arachide = self.env.ref(
            "account_invoice_invoice2data.invoice_line_relais_vert_1_arachide"
        )
        self.tax_055 = self.env.ref("account_invoice_invoice2data.tax_055")
        self.tax_200 = self.env.ref("account_invoice_invoice2data.tax_200")
