...
class TestErrorNoDate(TestModule):
    def setUp(self):
        super().setUp()
        ...
        # Prepare binary data
        self.invoice_name = (
            "brasserie-teddy-beer__2222-12-01__FA2212-3445__error__no-date.pdf"
        )
    ...
    def test_full_workflow_error_no_date(self):
        ...
        # This will raise an invoice2data error "Unable to match all required fields"
        wizard.import_invoice()

        self.assertEqual(wizard.state, "import_errored")
